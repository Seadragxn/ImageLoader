    ...
    IDisposable
{
    ...
    private void CreateNotes()
    {
        _panel.Append(
            CreateButton(
                "Terraria Screenshot Size",
                0f,
                253f,
                235f,
                40f,
                TerrariaScreenshotScaleClicked
            )
        );

        var screenshotHint =
            new UIText(
                "For native 100% Terraria screenshots: 16 source pixels become one placed block.",
                0.68f
            )
            {
                TextColor =
    ...
    private void TerrariaScreenshotScaleClicked(
        UIMouseEvent evt,
        UIElement listeningElement
    )
    {
        ...
        {
            SetStatus(
                "Load a Terraria screenshot before applying its tile-grid size.",
                Color.OrangeRed
            );
        ...
        SetStatus(
            $"Terraria screenshot grid set to {width} x {height} blocks. Use Exact RGB for the closest visual copy, or Vanilla Blocks for real Terraria materials.",
            Color.LightGreen
        );
    }
